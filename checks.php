        ...
        <div class="row">
          ...
          <li class="has-children">
            ...
            <ul>
              ...
              $products = $con->prepare("SELECT count, Products.id, img_path, orders_products.price, name FROM orders_products, Products WHERE (product_id=Products.id AND order_id=$currentOrder)");
              $products->execute();
