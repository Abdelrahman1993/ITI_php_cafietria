...
CREATE TABLE `Orders` (
  ...
  KEY `room_id` (`room_id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `Orders_ibfk_1` FOREIGN KEY (`room_id`) REFERENCES `Room` (`id`),
...
INSERT INTO `User` VALUES (2,'awad','awadmohamed233@gmail.com','01111451253','img.png',1);
...
-- Dump completed on 2019-03-11 10:00:36
